...
function Add_new_e_student({rece_data1})
{
            ...
            let[stdinfo, setstdinfo]=useState({img1:"",roll_no:"",name:"",standardandsection:"",gender:"",dob:"",doj:"",address:"",mobile:"",father:"",gaurdien:"",classTeacher:"",other:"", userid:userId})
            let[stdinfo_error, setstdinfo_error]=useState({img1:false,roll_no:false,Name:false,Standardandsection:false,gender:false,DOB:false,DOJ:false,Address:false,Mobile:false,Father:false,Gaurdien:false,classTeacher:false,Other:false})
            ...
            tempErrors={...stdinfo_error}
                   ...
                   function data_fun(e)
                    ...
                    function verifystd()
                    {
                        ...
                        if(stdinfo.standardandsection.length<2)
                          {
    ...
    return(
                  <div className="col-8">
                                <h3 className="text-danget">Edit Student Details</h3>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-6">
                                                <div className="card -body std_rec_add"> 
                                                 <label><strong>Std(roll_no)</strong></label>
                                                 <input type="text" className='form-control std_rec_add1 ' placeholder='Std(roll_no)' onChange={e=>setstdinfo({...stdinfo, roll_no:e.target.value})} ></input>
                                                 
                                                 { stdinfo_error.roll_no==true && <div className="text-danger"> Min 2 charecters</div>}
                                                 ...
                                                 <input type="text" className='form-control std_rec_add1 ' placeholder='Standard and section' onChange={e=>setstdinfo({...stdinfo, standardandsection:e.target.value})}></input>
                                                  { stdinfo_error.Standardandsection==true && <div className="text-danger"> Min 2 charecters</div>}
                                                    ...
                                                    <div className="card -body std_rec_add">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-9">
                                                                ...
                                                                <input type="text" className='form-control mt-4' placeholder="--optional--" onChange={e=>setstdinfo({...stdinfo, gaurdien:e.target.value})}/>
...
export default Add_new_e_student