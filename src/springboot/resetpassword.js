...
function Springbootresetpassword()
{
   ...
   async function createaccount()
  {
            ...
            let apires=await axios.post('http://localhost:8080/resetpassword',userInputdata)
              // window.location='http://localhost:8080/login'
              console.log(apires.data)
              setapiresponce_SB({...apires.data})
              console.log(userInputdata)
                                                    ...
                                                    <div className="card -body ">
                                                        <h3>reset password</h3>
                                                            ...
                                                            <div className='mt-3'>
                                                                    ...
                                                                    <input type="text" className='form-control' placeholder='Email' onChange={e => updateconformpassword(e)}></input>
                                                            </div>
...
export default Springbootresetpassword;